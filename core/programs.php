...
<?php if (!isset($_GET['csv_programs'])) { $_SESSION['installedprograms'] = $_SERVER['REQUEST_URI']; } ?>
			...
			<div class="grid">
				<div class="row">
					...
					function update() {
						$.ajax({
							type: "GET",
							url: 'programsjq.php?orderby=<?php echo $orderby; ?>&filter=<?php echo urlencode($filter); ?>&page=<?php echo $pgkey; ?>&phptimeout=120',
							data: '',
							dataType: 'json',
							cache: false,
							timeout: 120000,
