...
<script type="text/javascript">
	function endprocess(IDProcess,Name,PercentProcessorTime,WorkingSetPrivate,CreatingProcessID,LimitName){
		...
		if (CreatingProcessID == '0') { CreatingProcessIDHr = CreatingProcessID; } else { CreatingProcessIDHr = '<a href="/processes.php?filter=IDProcess.' + CreatingProcessID + '..IDProcess" style="font-size:12px;" title="Filter by Parent PID"><div class="icon-bars"></div>' + CreatingProcessID + '</a>'; }
		$.Dialog({
