...
foreach ($explorerarray as $explorerrow) {
	if (is_dir($path . '\\' . $explorerrow[2] . '\\')) {
		...
		$expicon = $expdwn . '<div class="icon-file" style="margin-top:1px;"></div></a>';
		if (strpos('||asf|3gp|asx|avi|m1s|m2a|m2s|m2v|mkv|mov|mp2|mp2v|mp4|mpa|mpe|mpeg|mpg|ogm|qt|ram|rm|rmvb|wmv|wmx|', '|' . $explorerrow[5] . '|')) { $expicon = $expdwn . '<div class="icon-film" style="margin-top:1px;"></div></a>'; }
		if (strpos('||aac|aiff|atrac|au|dct|gsm|mp3|ogg|ra|vox|wav|wma|flac|', '|' . $explorerrow[5] . '|')) { $expicon = $expdwn . '<div class="icon-playlist" style="margin-top:1px;"></div></a>'; }
		if (strpos('||ascx|asp|aspx|php|', '|' . $explorerrow[5] . '|')) { $expicon = $expdwn . '<div class="icon-file-css" style="margin-top:1px;"></div></a>'; }
		if (strpos('||htm|html|xml|css|', '|' . $explorerrow[5] . '|')) { $expicon = $expdwn . '<div class="icon-file-xml" style="margin-top:1px;"></div></a>'; }
		if (strpos('||bat|cmd|', '|' . $explorerrow[5] . '|')) { $expicon = $expdwn . '<div class="icon-console" style="margin-top:1px;"></div></a>'; }
		if (strpos('||exe|msi|msu|msp|com|', '|' . $explorerrow[5] . '|')) { $expicon = $expdwn . '<div class="icon-windows" style="margin-top:1px;"></div></a>'; }
		if (strpos('||dll|drv|sys|', '|' . $explorerrow[5] . '|')) { $expicon = $expdwn . '<div class="icon-embed" style="margin-top:1px;"></div></a>'; }
		if (strpos('||vbs|', '|' . $explorerrow[5] . '|')) { $expicon = $expdwn . '<div class="icon-cog" style="margin-top:1px;"></div></a>'; }
		if (strpos('||pdf|', '|' . $explorerrow[5] . '|')) { $expicon = $expdwn . '<div class="icon-file-pdf" style="margin-top:1px;"></div></a>'; }
		if (strpos('||log|txt|csv|inf|ini|', '|' . $explorerrow[5] . '|')) { $expicon = $expdwn . '<div class="icon-libreoffice" style="margin-top:1px;"></div></a>'; }
		if (strpos('||7z|arj|bz2|bzip2|cab|cpio|deb|dmg|fat|gz|gzip|hfs|iso|lha|lzh|lzma|ntfs|rar|rpm|squashfs|swm|tar|taz|tbz|tbz2|tgz|tpz|txz|vhd|wim|xar|xz|z|zip|', '|' . $explorerrow[5] . '|')) { $expicon = $expdwn . '<div class="icon-file-zip" style="margin-top:1px;"></div></a>'; }
		if (strpos('||doc|docm|docx|dot|dotm|dotx|', '|' . $explorerrow[5] . '|')) { $expicon = $expdwn . '<div class="icon-file-word" style="margin-top:1px;"></div></a>'; }
		if (strpos('||xl|xla|xlb|xlc|xld|xlk|xll|xlm|xls|xlsm|xlsx|xlt|xltm|xltx|xlv|xlw|', '|' . $explorerrow[5] . '|')) { $expicon = $expdwn . '<div class="icon-file-excel" style="margin-top:1px;"></div></a>'; }
		if (strpos('||potm|potx|ppam|pps|ppsm|ppsx|ppt|pptm|pptx|sldm|sldx|', '|' . $explorerrow[5] . '|')) { $expicon = $expdwn . '<div class="icon-file-powerpoint" style="margin-top:1px;"></div></a>'; }
		if (strpos('||art|bmp|gif|ico|j2c|j2k|jfif-tbnl|jfif|jif|jp2|jpe|jpeg|jpg|jps|jpx|png|tif|tiff|wbmp|', '|' . $explorerrow[5] . '|')) { $expicon = $expdwn . '<div class="icon-pictures" style="margin-top:1px;"></div></a>'; }
