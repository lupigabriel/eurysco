...
<?php if (!isset($_GET['csv_nagios'])) { $_SESSION['nagios'] = $_SERVER['REQUEST_URI']; } ?>
			...
			<div class="grid">
				<div class="row">
					...
					function update() {
						$.ajax({
							type: "GET",
							url: 'nagiosjq.php?orderby=<?php echo $orderby; ?>&filter=<?php echo urlencode($filter); ?>&page=<?php echo $pgkey; ?>&nrpepathname=<?php echo $nrpepathname; ?>&nscppathname=<?php echo $nscppathname; ?>&phptimeout=120',
							data: '',
							dataType: 'json',
							cache: false,
