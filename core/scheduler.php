...
<?php if (!isset($_GET['csv_scheduler'])) { $_SESSION['scheduler'] = $_SERVER['REQUEST_URI']; } ?>
			...
			<div class="grid">
				<div class="row">
					...
					function update() {
						$.ajax({
							type: "GET",
							url: 'schedulerjq.php?orderby=<?php echo $orderby; ?>&filter=<?php echo urlencode($filter); ?>&page=<?php echo $pgkey; ?>&phptimeout=<?php echo $phptimeout; ?>&osmver=<?php echo $osversion; ?>',
							data: '',
							dataType: 'json',
							cache: false,
